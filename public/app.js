...
const state = { data:null, view:'core', selectedDepartment:null, selectedTask:null, report:null, pendingReplyTaskId:null, voiceOn:false };
...
async function refreshSettings() {
  ...
  try {
    const [devices,chatwork] = await Promise.all([request('/api/devices'),request('/api/chatwork/status')]);
